...
export default function JourneyExperience() {
  ...
  return <div className="journey-experience"><Canvas camera={{ position: [0, .3, 5.5], fov: 38 }} dpr={[1, 1.5]} gl={{ antialias: true, alpha: true }}><ExperienceScene progress={progress} /></Canvas>{progress > .06 && <div className="journey-overlay"><p>{stage.name} · 0{stageIndex + 1}</p></div>}</div>;
}
